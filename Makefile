...
Request/utils.cpp Request/selection.cpp Response/delete_method.cpp Response/get_method.cpp \
Response/post_method.cpp Response/resp_utils.cpp Response/auto_index.cpp Cgi/cgi.cpp
OBJS = $(SRCS:.cpp=.o)
CC = c++
